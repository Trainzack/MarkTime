...
urlpatterns = [
    ...
    path('history/year/<int:queried_year>/', views.history_page, name='MarkTime-HistoryPage'),
    path('history/picture/<int:pic_id>/', views.picture_detail, name='MarkTime-PictureDetail'),
